...
<body class="user-body">
  ...
  <main class="user-content booking-content">
    ...
    <section class="booking-main-layout">
      <!-- LEFT: HOTEL LIST + FILTER -->
      <div class="booking-form-area">
        <h1 class="booking-title">Select Your Hotel</h1>
        <p class="booking-subtitle">
          Choose accommodation that suits your needs and budget.
        </p>

        <!-- Simple filter row (visual only, you can wire it later) -->
        <section class="hotel-filter card">
          <span class="filter-label">Filter by Rating:</span>
          <label class="filter-option">
            <input type="radio" name="ratingFilter" value="all" checked> All
          </label>
          <label class="filter-option">
            <input type="radio" name="ratingFilter" value="3"> ★★★ 3 Star
          </label>
          <label class="filter-option">
            <input type="radio" name="ratingFilter" value="4"> ★★★★ 4 Star
          </label>
          <label class="filter-option">
            <input type="radio" name="ratingFilter" value="5"> ★★★★★ 5 Star
          </label>
        </section>

        <!-- Scrollable hotel list -->
        <section class="hotel-list card">
          <div id="hotelListInner">
            <!-- Hotels rendered by JS -->
          </div>
        </section>
      </div>
    ...
    <footer class="booking-footer">
      ...
      <div class="booking-step-indicator">
        ...
        <div class="step-progress-bar">
          <div class="step-progress-fill step4"></div>
        </div>
      </div>
