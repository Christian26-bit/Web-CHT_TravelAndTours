  ...
  <main class="user-content booking-content">
    ...
    <section class="booking-main-layout">
      ...
      <div class="booking-form-area">
        <h1 class="booking-title">Customize Your Trip</h1>
        <p class="booking-subtitle">
          Add optional services to enhance your travel experience.
        </p>

        <!-- AVAILABLE ADD-ONS -->
        <section class="addons-card card">
          <header class="addons-header">
            <span class="addons-title">Available Add-ons</span>
          </header>
        ...
        <!-- SPECIAL REQUESTS -->
        <section class="special-requests card">
          <header class="addons-header">
            <span class="addons-title">Special Requests</span>
          </header>
          <p class="special-info">
            Let us know about any dietary restrictions, allergies, or special needs.
          </p>
          <textarea id="specialRequests" rows="5" placeholder="Type your special requests here..."></textarea>
        </section>
      </div>
      ...
      <aside class="booking-summary">
        <div class="summary-header">
          ...
          <p class="summary-progress-label">
            ...
            <span id="summaryPercent">60% Complete</span>
          </p>
        </div>
        ...
        <div class="summary-progress-circle">
          <div class="circle-outer">
            <div class="circle-inner">
              <span id="summaryStepFraction">3/5</span>
            </div>
          </div>
          <p class="summary-total-label">Estimated Total</p>
          <p class="summary-total-amount" id="summaryTotal">₱0</p>
          <p class="summary-total-note" id="summaryBreakdown">Package: ₱0</p>
        </div>
      </aside>
    </section>
    ...
    <footer class="booking-footer">
      ...
      <div class="booking-step-indicator">
        ...
        <div class="step-progress-bar">
          <div class="step-progress-fill step3"></div>
        </div>
      </div>
