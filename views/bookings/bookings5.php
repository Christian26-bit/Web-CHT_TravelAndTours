...
<body class="user-body">
  ...
  <main class="user-content booking-content">
    ...
    <section class="booking-main-layout">
      <!-- LEFT: TRANSPORT LIST + FILTER -->
      <div class="booking-form-area">
        <h1 class="booking-title">Choose Transportation</h1>
        <p class="booking-subtitle">
          Select a vehicle that accommodates your group size.
        </p>

        <!-- Filter by type (visual) -->
        <section class="transport-filter card">
          <span class="filter-label">Filter by Type:</span>
          <label class="filter-option">
            <input type="radio" name="transportFilter" value="all" checked> All
          </label>
          <label class="filter-option">
            <input type="radio" name="transportFilter" value="sedan"> 🚗 Sedan (4 seats)
          </label>
          <label class="filter-option">
            <input type="radio" name="transportFilter" value="van"> 🚐 Van (10 seats)
          </label>
          <label class="filter-option">
            <input type="radio" name="transportFilter" value="bus"> 🚌 Bus (50 seats)
          </label>
        </section>

        <section class="transport-list card">
          <div id="transportListInner">
            <!-- rows rendered by JS -->
          </div>
        </section>
      </div>
      ...
      <aside class="booking-summary">
        <div class="summary-header">
          ...
          <p class="summary-progress-label">
            ...
            <span id="summaryPercent">80% Complete</span>
          </p>
        </div>
        ...
        <div class="summary-progress-circle">
          <div class="circle-outer">
            <div class="circle-inner">
              <span id="summaryStepFraction">4/5</span>
            </div>
          </div>
    ...
    <footer class="booking-footer">
      ...
      <div class="booking-step-indicator">
        ...
        <div class="step-progress-bar">
          <div class="step-progress-fill step5"></div>
        </div>
      </div>
