...
<body class="app-body">
  ...
  <aside class="sidebar">
    ...
    <nav class="sidebar-menu">
      ...
      <a href="admin/employees" class="sidebar-item active">
        <span class="sidebar-icon">👥</span> Employees
      </a>
    </nav>

    <div class="sidebar-footer">
      <button class="link-btn" id="logoutBtnEmployees">⟵ Logout</button>
    </div>
  </aside>
  ...
  <main class="content">
    ...
    <header class="content-header">
      ...
      <div class="content-header-right">
        <button class="btn btn-primary small" id="scrollToEmployeeFormBtn">👤 Add New Employee</button>
      </div>
    </header>
    ...
    <section class="toolbar">
      <div class="search-group">
        ...
        <button class="btn btn-secondary small" id="refreshEmployeeBtn">⟳ Refresh</button>
      </div>
